  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        dark: '0 4px 30px rgba(0, 0, 0, 0.2)',
        'dark-hover': '0 10px 40px rgba(0, 0, 0, 0.35)',
      ...
      fontSize: {
        ...
        '2xl': ['1.5rem', { lineHeight: '2.125rem', letterSpacing: '-0.022em' }],
        '3xl': ['1.875rem', { lineHeight: '2.375rem', letterSpacing: '-0.025em' }],
        '4xl': ['2.25rem', { lineHeight: '2.75rem', letterSpacing: '-0.03em' }],
      },
      transitionProperty: {
        'theme': 'background-color, border-color, text-color, fill, stroke, box-shadow',
      },
      transitionDuration: {
        '300': '300ms',
      },
