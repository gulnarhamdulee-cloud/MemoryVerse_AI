...
import {
  Brain, Mail, Lock, ArrowRight, Sun, Moon, Compass,
      ...
      <div className="hidden lg:flex lg:w-1/2 p-12 flex-col justify-between relative overflow-hidden transition-colors duration-300"
        ...
        <div className="max-w-md space-y-6 z-10 my-auto">
          ...
          <h2 className="text-3xl font-black tracking-tight leading-tight" style={{ color: isDark ? '#fff' : '#0f172a' }}>
            Preserve the context of your <span className="mv-grad-text">digital life</span>.
          </h2>
          <p className="text-xs leading-relaxed font-medium" style={{ color: isDark ? '#64748b' : '#475569' }}>
            Join the personal memory workspace where documents, tags, activities, and concepts emerge together. Built with total vector database security and SQLite mapping support.
          </p>
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-between p-6 sm:p-12 relative overflow-y-auto">
        ...
        <div className="my-auto max-w-sm w-full mx-auto p-6 sm:p-8 rounded-2xl transition-all duration-300 border"
          ...
          <div className="space-y-2 mb-6">
            <h1 className="text-2xl font-black tracking-tight" style={{ color: isDark ? '#fff' : '#0f172a' }}>Sign In</h1>
            <p className="text-xs" style={{ color: isDark ? '#64748b' : '#64748b' }}>Enter credentials to access your second brain.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center gap-2 py-1">
              ...
              />
              <label htmlFor="remember" className="text-xs cursor-pointer font-medium select-none"
